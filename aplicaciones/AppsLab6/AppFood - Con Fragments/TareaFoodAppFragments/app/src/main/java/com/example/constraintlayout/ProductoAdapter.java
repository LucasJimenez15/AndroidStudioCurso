...
public class ProductoAdapter extends RecyclerView.Adapter<ProductoAdapter.ListItemHolder>{
    ...
    private FragmentPaginaHome mMainActivity;
    ...
    public ProductoAdapter(FragmentPaginaHome paginaHome, List<Producto> productos) {
    ...
    public class ListItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Toast.makeText(view.getContext(), productos.get(getAdapterPosition()).getProducto(), Toast.LENGTH_SHORT).show();
        }
    }
}
